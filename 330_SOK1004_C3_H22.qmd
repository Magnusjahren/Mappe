...
#Ligningen beskriver prosentvis endring når det ikke er et n argument.
...
df_wide <- df_wide %>%
  aggregate(value2~dato, FUN = sum)
  
#De fleste avvikene ligger på ca 0,87 til 0,9
...
df4 <- df4 %>%
  mutate(total = df4$value * df_wide$value2)
...
#høyere kraftpriser fører til mindre penger i husholdningene. Det kan bety forbruk at varer og tjenester kuttes fordi, husholdningene ikke har råd. Det kan gjøre at produsentene må øke prisene på varer grunnet lavere salg.
